    ...
    <nav className="xd:hidden flex-[1_0_auto] justify-between items-center flex static float-right">
      ...
      <div className="gap-x-[1rem] gap-y-[1rem] items-center ml-4 flex">
        <motion.div
          ...
          } shadow-[0_0_0_1px_rgba(255,255,255,1)] flex cursor-pointer tracking-[.04rem] text-white bg-[#0000] p-[.5rem_1.25rem_.35rem] text-[1rem] text-center font-[family-name:var(--font-input-sans)] font-normal transition ease-in-out duration-200 hover:opacity-60 rounded-[.25rem]`}
        >
          Download CV
          <span className="ml-4">
            {!download && (
